<?php
    ...
    define('DOL_DEFAULT_UNIT', $conf->TARIF_DOL_DEFAULT_UNIT ); //'unite'  //Définie l'unité de vente par défaut des lignes de propale, commande, facture : weight, size, surface, volume

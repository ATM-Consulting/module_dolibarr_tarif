...
class modTarif extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		$res = $extrafields->addExtraField('tarif_longueur', 'Longueur', 'double', 0, '', 'propaldet', 0, 0, '');
		$res = $extrafields->addExtraField('tarif_largeur', 'Largeur', 'double', 0, '', 'propaldet', 0, 0, '');
		$res = $extrafields->addExtraField('tarif_longueur', 'Longueur', 'double', 0, '', 'commandedet', 0, 0, '');
		$res = $extrafields->addExtraField('tarif_largeur', 'Largeur', 'double', 0, '', 'commandedet', 0, 0, '');
		$res = $extrafields->addExtraField('tarif_longueur', 'Longueur', 'double', 0, '', 'facturedet', 0, 0, '');
		$res = $extrafields->addExtraField('tarif_largeur', 'Largeur', 'double', 0, '', 'facturedet', 0, 0, '');

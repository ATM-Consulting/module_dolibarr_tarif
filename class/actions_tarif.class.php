				...
				if(defined('DONT_ADD_UNIT_SELECT') && DONT_ADD_UNIT_SELECT) {
					null;
		         	...
		         	$('#np_desc').parent().next().after('<td align="right" tarif-col="conditionnement_product"><span id="AffUnite" style="display:none;">unité</span><?php
		         			...
		         			print ($type_unite=='unite') ? 'U' :  $formproduct->select_measuring_units("weight_unitsAff_product", ($res->unite_vente) ? $res->unite_vente : DOL_DEFAULT_UNIT,-6); 
		         	...
		         	$('#dp_desc').parent().next().next().next().after('<td align="right" tarif-col="conditionnement_libre"><?
		         		...
		         		print ($type_unite=='unite') ? 'U' :  $formproduct->select_measuring_units("weight_unitsAff_libre", ($res->unite_vente) ? $res->unite_vente : DOL_DEFAULT_UNIT,-6); 
		         		?></td>');  	<?php 
				}
